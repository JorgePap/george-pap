      ...
      {!isTextArea ? (
        <div className="flex flex-col w-full">
          <input
            ...
            onBlur={handleBlur}
            onFocus={handleFocus}
            className="w-full placeholder-neutral-1 bg-[#454158] pl-[20px] md:pl-[25px] lg:pl-[30px] pr-[16px] py-[16px] rounded-md"
          />
          <span
            className={`text-neutral-1 absolute left-0 px-lg py-md transition duration-200 input-text
                        ${
                          (hasFocus || isDirty) &&
        ...
        <div className="flex flex-col w-full">
          <textarea
            ...
            onBlur={handleBlur}
            onFocus={handleFocus}
            className={`placeholder-neutral-1 bg-[#454158] px-md py-sm rounded-md
                   `}
          />
          <span
            className={`text-neutral-1 absolute left-0 p-md transition duration-200 input-text
                        ${
                          (hasFocus || isDirty) &&
