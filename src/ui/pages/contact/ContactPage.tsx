...
import { CONTACT, NAVBAR } from "@translations";
...
export const ContactPage: FC = () => {
  ...
  return (
    <div
      className="h-dvh pt-[80px] md:pt-[110px] lg:pt-[140px] px-[30px] md:px-[115px] lg:px-[130px]
                 xl:px-[150px] pb-[40px] md:pb-[80px] overflow-x-hidden relative"
    >
